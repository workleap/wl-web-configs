# Chromatic Audit Checks

Detailed procedures for each check in the audit workflow. Each check includes what to find, what to look for, and the required action.
...
After completing the audit, provide a summary using this format:
